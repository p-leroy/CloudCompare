...
#define CC_CURVATURE_SIGNED_N_GAUSSIAN_FIELD_NAME "Gaussian curvature (sign N)"
#define CC_CURVATURE_SIGNED_Z_GAUSSIAN_FIELD_NAME "Gaussian curvature (sign +Z)"
#define CC_CURVATURE_SIGNED_N_MEAN_FIELD_NAME "Mean curvature (sign N)"
#define CC_CURVATURE_SIGNED_Z_MEAN_FIELD_NAME "Mean curvature (sign +Z)"
