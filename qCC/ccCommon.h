...
#define CC_CURVATURE_SIGNED_N_GAUSSIAN_FIELD_NAME "Gaussian curvature (signed with n)"
#define CC_CURVATURE_SIGNED_Z_GAUSSIAN_FIELD_NAME "Gaussian curvature (signed with +z)"
#define CC_CURVATURE_SIGNED_N_MEAN_FIELD_NAME "Mean curvature (signed with n)"
#define CC_CURVATURE_SIGNED_Z_MEAN_FIELD_NAME "Mean curvature (signed with +z)"
#define CC_CURVATURE_NORM_CHANGE_RATE_FIELD_NAME "Normal change rate"
#define CC_CURVATURE_TYPE_OF_QUADRIC_FIELD_NAME "Type of quadric"
